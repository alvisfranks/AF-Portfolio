<footer class="footer">
    <div class="wrapper">
        <div class="contacts">
            <a href="mailto:franks@e6.lv">franks@e6.lv</a>
            <a href="tel:+37129900453">+371 29900453</a>
        </div>
        <div class="socials">
            <a href="https://www.linkedin.com/in/alvisfranks/">
                <svg
                    width="48"
                    height="48"
                    viewBox="0 0 48 48"
            ...
            <a href="https://www.instagram.com/franks_e6/">
                <svg
                    width="48"
                    height="48"
                    viewBox="0 0 48 48"
            ...
            <a href="https://www.tiktok.com/@alvisfranks?lang=en">
                <svg
                    width="48"
                    height="48"
                    viewBox="0 0 48 48"
